...
class Cartthrob_realex_redirect_ext
{
    public $settings = [];
    public $module_name = 'cartthrob_realex_redirect';
    ...
    {
        ee()->lang->load('cartthrob_realex_redirect', $idiom = '', $return = false, $add_suffix = true, $alt_path = __DIR__ . '/');
        ee('cartthrob:PluginService')->register(Cartthrob_realex_redirect::class);
    }
}
